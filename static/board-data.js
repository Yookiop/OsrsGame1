...
const R = Object.freeze([
  { id:'misthalin', name:'Misthalin', color:'#FFC107', emoji:'🏰',
  ...
  { id:'asgarnia', name:'Asgarnia', color:'#FF1493', emoji:'🪓',
  ...
  { id:'fremennik', name:'Fremennik', color:'#00FFFF', emoji:'⚔️',
  ...
  { id:'wilderness', name:'Wilderness', color:'#9E9E9E', emoji:'💀',
  ...
  { id:'karamja', name:'Karamja', color:'#5D4037', emoji:'🌋',
  ...
  { id:'varlamore', name:'Varlamore', color:'#FF9800', emoji:'🏟️',
  ...
  { id:'kandarin', name:'Kandarin', color:'#F44336', emoji:'🏔️',
    bosses:[]},
]);
